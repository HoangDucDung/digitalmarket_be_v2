...
<#
.SYNOPSIS
    Build Docker image cho Digitalmarket Business API
...
.EXAMPLE
    ...
    .\build-docker.ps1 -ImageTag "latest" -Run -Port 8080
#>
...
$ImageName = "digitalmarket-business"
$FullImageName = "$ImageName`:$ImageTag"
$DockerfilePath = "Presentation/API/Digitalmarket.Controller.Business/Dockerfile"

Write-Header "Docker Build - Digitalmarket Business API"
Write-Host ""
...
if ($Run) {
    Write-Host ""
    $ContainerName = "business-api-$(Get-Date -Format yyyyMMdd-HHmmss)"
    ...
    Write-Success "Application ready at: http://localhost:$Port"
