...
{
    /// <inheritdoc />
    public partial class Initial_Fresh_Start : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Material = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_Status", "[Status] IN ('Draft','Published','Archived')");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), "d20b7f0c-8e0b-5a2b-c2d9-6b3d4e5f6a7b", "Seller", "SELLER" },
                    { new Guid("8d04dce2-969a-435d-bba4-072895a5531b"), "c30c8f1d-9f1c-6b3c-d3e0-7c4d5e6f7a8b", "Admin", "ADMIN" },
                    { new Guid("b74ddd14-6340-4840-95c2-db12554843e5"), "e10a6f9b-7d9a-4f1a-b1c8-5a2c3d4e5f6a", "Customer", "CUSTOMER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2026, 3, 28, 13, 33, 5, 334, DateTimeKind.Local).AddTicks(3234), null, true, false, "No Brand", "no-brand", null, null },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2026, 3, 28, 13, 33, 5, 334, DateTimeKind.Local).AddTicks(3238), null, true, false, "Nike", "nike", null, null }
                });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "IsActive", "IsDeleted", "Level", "Name", "ParentId", "Slug", "SortOrder", "UpdatedAt", "UpdatedBy" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2026, 3, 28, 13, 33, 5, 334, DateTimeKind.Local).AddTicks(3177), null, true, false, 1, "Thoi trang nam", null, "thoi-trang-nam", 1, null, null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2026, 3, 28, 13, 33, 5, 334, DateTimeKind.Local).AddTicks(3196), null, true, false, 2, "Ao thun", new Guid("11111111-1111-1111-1111-111111111111"), "ao-thun", 1, null, null }
                });
