        ...
        failure {
            script {
                if (env.GIT_COMMIT) {
                    ...
                    echo '⚠️ Bỏ qua gửi GitHub Status vì thiếu thông tin Commit SHA.'
                }
            }
